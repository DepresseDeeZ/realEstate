    ...
    <footer className="max-padd-container mb-4">
      <div className="max-padd-container bg-primary rounded-tr-3xl pt-12 xl:pt-20 pb-8">
        ...
        <p>
          ...
          expedita exercitationem nostrum nihil in cupiditate maiores modi
          adipisci deleniti quae inventore, veritatis, quisquam possimus eveniet
          unde!
        </p>
        ...
        <div className="flex justify-between flex-wrap gap-x-2 gap-y-8">
          <div className="max-w-sm">
            ...
            <p className="py-4">
              ...
              veritatis dolores amet molestiae iste aliquid deleniti saepe sed
              minus aperiam modi, beatae, ipsum voluptatibus? Sequi adipisci
              animi molestiae quisquam qui.
            </p>
      ...
      <p className="text-white bg-tertiary medium-14 py-2 px-8 rounded-b-3xl flexBetween">
        <span>2026 EstateHub</span>All rights reserved
      </p>
    </footer>
  );
};
